    ...
    <nav class="navbar">
        <div class="navbar-container container ">
            ...
            <ul class="menu-items">
                ...
                <li><a href="../adminPanel/login.php" target="_target">Login</a></li>
            ...
            <h1 class=" animate__animated animate__bounce"><img src="assets/images/sushi1.png" alt="" width="100px" height="80px" ></h1>
    ...
    <section id="about">
        <div class="about-wrapper container">
            <div class="about-text">
                ...
                <!-- <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quo vitae molestias commodi praesentium iste doloremque, voluptas libero, mollitia placeat deserunt illum asperiores repellendus tempore rem ratione maxime veniam laudantium totam esse aspernatur sed veritatis voluptate magni. Velit id assumenda et.</p> -->
   ...
   <!-- <section id="contact">
    <div class="contact-container container">
        <div class="contact-image">
            <img src="assets/images/restraunt-image.jpg" alt="">
        </div>
